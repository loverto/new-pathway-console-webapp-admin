<template>
  <div class="app-container agent-wrapper">
    ...
    <el-table v-loading="listLoading" :data="list" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column align="center" label="代理姓名" width="150">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" label="贴膜使用次数" width="200">
        <template slot-scope="scope">
          <span>{{ scope.row.tmCount }}</span>
        </template>
      </el-table-column>

      <el-table-column align="center" label="鼠标垫使用次数" width="200">
        <template slot-scope="scope">
