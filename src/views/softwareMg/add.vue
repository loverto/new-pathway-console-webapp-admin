  ...
  <div class="app-container product-wrapper">
    <div class="form-wrapper">
      <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="100px">
        <el-form-item label="软件:" prop="name">
          <el-input v-model="ruleForm.name" placeholder="软件代码值" class="width-50p" />
        </el-form-item>
...
<script>
import { saveOrUpdate } from '@/api/software'
